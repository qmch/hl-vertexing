...
void HSSpacingPlot(){
  ...
  */
  ...
  my_histo->SetTitle("Hard scatter vertex separation in Hinv.root");
  my_histo->GetXaxis()->SetTitle("Distance between reconstructed and truth");
  ...
  //c1->Print("plots/output_HSSpacingPlot_tight.pdf");
